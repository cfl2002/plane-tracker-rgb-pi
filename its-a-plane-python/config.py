...
TEMPERATURE_LOCATION = "44.971718,-93.278106" #same as location home
TOMORROW_API_KEY = "kKkhV3fXHcC9Bi0rJZTOtA2Svu3CLxKN" # Get an API key from https://tomorrow.io they only allows 25 pulls an hour, if you reach the limit you'll need to wait until the next hour 
...
JOURNEY_CODE_SELECTED = "MSP" #your home airport code
JOURNEY_BLANK_FILLER = " NA " #what to display if theres no airport code
